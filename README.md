...
| Creating silver-standard label | Medical experts review                                       | NA                                                                        | NA                                                                                                                                                                                                                                                                                                                                                                                     |
...
|-----------------|--------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| Modified LATTE  | A modified explanation of LATTE                                    | [Modified LATTE](https://github.com/SHENRMARKDOWN/Protocol-for-deriving-longitudinal-Clinical-Outcomes-from-electronic-health-records/blob/main/LATTE_files/Modified_LATTE.pdf)        | TBD        |
| Data generation | A detailed explanation of generating data(for simulation) in LATTE | [Data generation](https://github.com/SHENRMARKDOWN/Protocol-for-deriving-longitudinal-Clinical-Outcomes-from-electronic-health-records/blob/main/LATTE_files/LatteDataGen.pdf)         | TBD        |
